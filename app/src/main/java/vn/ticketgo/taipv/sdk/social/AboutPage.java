package vn.ticketgo.taipv.sdk.social;
...
public class AboutPage {
    ...
    public AboutPage(Context context) {
        ...
        this.mView = mInflater.inflate(vn.ticketgo.taipv.ticketgo.R.layout.about_page, null);
    }
    ...
    public AboutPage addEmail(String email) {
        return addEmail(email, mContext.getString(vn.ticketgo.taipv.ticketgo.R.string.about_contact_us));
    }
    ...
    public AboutPage addEmail(String email, String title) {
        ...
        emailElement.setIconDrawable(vn.ticketgo.taipv.ticketgo.R.drawable.about_icon_email);
        emailElement.setIconTint(vn.ticketgo.taipv.ticketgo.R.color.about_item_icon_color);
    ...
    public AboutPage addFacebook(String id) {
        return addFacebook(id, mContext.getString(vn.ticketgo.taipv.ticketgo.R.string.about_facebook));
    }
    ...
    public AboutPage addFacebook(String id, String title) {
        ...
        facebookElement.setIconDrawable(vn.ticketgo.taipv.ticketgo.R.drawable.about_icon_facebook);
        facebookElement.setIconTint(vn.ticketgo.taipv.ticketgo.R.color.about_facebook_color);
    ...
    public AboutPage addTwitter(String id) {
        return addTwitter(id, mContext.getString(vn.ticketgo.taipv.ticketgo.R.string.about_twitter));
    }
    ...
    public AboutPage addTwitter(String id, String title) {
        ...
        twitterElement.setIconDrawable(vn.ticketgo.taipv.ticketgo.R.drawable.about_icon_twitter);
        twitterElement.setIconTint(vn.ticketgo.taipv.ticketgo.R.color.about_twitter_color);
    ...
    public AboutPage addPlayStore(String id) {
        return addPlayStore(id, mContext.getString(vn.ticketgo.taipv.ticketgo.R.string.about_play_store));
    }
    ...
    public AboutPage addPlayStore(String id, String title) {
        ...
        playStoreElement.setIconDrawable(vn.ticketgo.taipv.ticketgo.R.drawable.about_icon_google_play);
        playStoreElement.setIconTint(vn.ticketgo.taipv.ticketgo.R.color.about_play_store_color);
    ...
    public AboutPage addYoutube(String id) {
        return addYoutube(id, mContext.getString(vn.ticketgo.taipv.ticketgo.R.string.about_youtube));
    }
    ...
    public AboutPage addYoutube(String id, String title) {
        ...
        youtubeElement.setIconDrawable(vn.ticketgo.taipv.ticketgo.R.drawable.about_icon_youtube);
        youtubeElement.setIconTint(vn.ticketgo.taipv.ticketgo.R.color.about_youtube_color);
    ...
    public AboutPage addInstagram(String id) {
        return addInstagram(id, mContext.getString(vn.ticketgo.taipv.ticketgo.R.string.about_instagram));
    }
    ...
    public AboutPage addInstagram(String id, String title) {
        ...
        instagramElement.setIconDrawable(vn.ticketgo.taipv.ticketgo.R.drawable.about_icon_instagram);
        instagramElement.setIconTint(vn.ticketgo.taipv.ticketgo.R.color.about_instagram_color);
    ...
    public AboutPage addGitHub(String id) {
        return addGitHub(id, mContext.getString(vn.ticketgo.taipv.ticketgo.R.string.about_github));
    }
    ...
    public AboutPage addGitHub(String id, String title) {
        ...
        gitHubElement.setIconDrawable(vn.ticketgo.taipv.ticketgo.R.drawable.about_icon_github);
        gitHubElement.setIconTint(vn.ticketgo.taipv.ticketgo.R.color.about_github_color);
    ...
    public AboutPage addWebsite(String url) {
        return addWebsite(url, mContext.getString(vn.ticketgo.taipv.ticketgo.R.string.about_website));
    }
    ...
    public AboutPage addWebsite(String url, String title) {
        ...
        websiteElement.setIconDrawable(vn.ticketgo.taipv.ticketgo.R.drawable.about_icon_link);
        websiteElement.setIconTint(vn.ticketgo.taipv.ticketgo.R.color.about_item_icon_color);
    ...
    public AboutPage addItem(Element element) {
        LinearLayout wrapper = (LinearLayout) mView.findViewById(vn.ticketgo.taipv.ticketgo.R.id.about_providers);
        wrapper.addView(createItem(element));
        wrapper.addView(getSeparator(), new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mContext.getResources().getDimensionPixelSize(vn.ticketgo.taipv.ticketgo.R.dimen.about_separator_height)));
        return this;
    }
    ...
    public AboutPage addGroup(String name) {
        ...
        TextViewCompat.setTextAppearance(textView, vn.ticketgo.taipv.ticketgo.R.style.about_groupTextAppearance);
        ...
        int padding = mContext.getResources().getDimensionPixelSize(vn.ticketgo.taipv.ticketgo.R.dimen.about_group_text_padding);
        ...
        ((LinearLayout) mView.findViewById(vn.ticketgo.taipv.ticketgo.R.id.about_providers)).addView(textView);
        return this;
    }
    ...
    private View createItem(final Element element) {
        ...
        mContext.getTheme().resolveAttribute(vn.ticketgo.taipv.ticketgo.R.attr.selectableItemBackground, outValue, true);
        wrapper.setBackgroundResource(outValue.resourceId);

        int padding = mContext.getResources().getDimensionPixelSize(vn.ticketgo.taipv.ticketgo.R.dimen.about_text_padding);
        ...
        TextView textView = new TextView(mContext);
        TextViewCompat.setTextAppearance(textView, vn.ticketgo.taipv.ticketgo.R.style.about_elementTextAppearance);
        LinearLayout.LayoutParams textParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        textView.setLayoutParams(textParams);
        if (mCustomFont != null) {
            textView.setTypeface(mCustomFont);
        ...
        if (element.getIconDrawable() != null) {
            ...
            int size = mContext.getResources().getDimensionPixelSize(vn.ticketgo.taipv.ticketgo.R.dimen.about_icon_size);
            LinearLayout.LayoutParams iconParams = new LinearLayout.LayoutParams(size, size);
            iconView.setLayoutParams(iconParams);
            int iconPadding = mContext.getResources().getDimensionPixelSize(vn.ticketgo.taipv.ticketgo.R.dimen.about_icon_padding);
            ...
            if (element.getAutoApplyIconTint()) {
                ...
                if (currentNightMode != Configuration.UI_MODE_NIGHT_YES) {
                    if (element.getIconTint() != null) {
                        ...
                        DrawableCompat.setTint(wrappedDrawable, ContextCompat.getColor(mContext, vn.ticketgo.taipv.ticketgo.R.color.about_item_icon_color));
                    }
    ...
    private View getSeparator() {
        return mInflater.inflate(vn.ticketgo.taipv.ticketgo.R.layout.about_page_separator, null);
    }
}
