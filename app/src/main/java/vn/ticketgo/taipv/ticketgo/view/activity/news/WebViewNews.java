package vn.ticketgo.taipv.ticketgo.view.activity.news;
...
public class WebViewNews extends BaseActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vn.ticketgo.taipv.ticketgo.R.layout.activity_webview_news);
    ...
    private void initView() {
        ...
        Log.d("", "initView: "+url);
                final WebView webView = findViewById(vn.ticketgo.taipv.ticketgo.R.id.webview);
