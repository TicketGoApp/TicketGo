...
import vn.ticketgo.taipv.ticketgo.adapter.NewsAdapter;
import vn.ticketgo.taipv.ticketgo.model.PostNews;
import vn.ticketgo.taipv.ticketgo.presenter.news.NewsPresenter;
import vn.ticketgo.taipv.ticketgo.util.EndlessRecyclerViewScrollListener;
import vn.ticketgo.taipv.ticketgo.view.activity.news.INewsView;
...
public class News extends BasicFragment implements INewsView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(vn.ticketgo.taipv.ticketgo.R.layout.fragment_news, container, false);
        return view;
...
//        webView.loadUrl("https://ticketgo.vn/blog");
    ...
    private void initRecyclerView(View view) {
        recyclerView=view.findViewById(vn.ticketgo.taipv.ticketgo.R.id.recycler_view_news);
