...
public class ProfileAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ItemHolder(layoutInflater.inflate(vn.ticketgo.taipv.ticketgo.R.layout.item_pro,parent,false));
...
//            MyApplication.log("list2",list.get(8).getTitleProfile()+"");
    ...
    private class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public ItemHolder(View inflate) {
            super(inflate);
            tileProfile=inflate.findViewById(vn.ticketgo.taipv.ticketgo.R.id.tv_title_prof);
            imgIconProfile=inflate.findViewById(vn.ticketgo.taipv.ticketgo.R.id.img_icon_prof);
        }
