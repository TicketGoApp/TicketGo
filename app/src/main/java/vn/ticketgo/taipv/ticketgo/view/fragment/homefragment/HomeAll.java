...
import vn.ticketgo.taipv.ticketgo.view.activity.HomeActivity;
...
public class HomeAll extends BasicFragment implements IHomeView, HomeActivity.OnBackPressedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(vn.ticketgo.taipv.ticketgo.R.layout.fragment_home, container, false);
        init();
        return view;
    }
    ...
    private void initRecyclerview(View view) {
        recyclerView = view.findViewById(vn.ticketgo.taipv.ticketgo.R.id.recycler_view);
